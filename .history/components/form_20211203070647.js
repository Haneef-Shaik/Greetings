...
function Edit() {
    ...
    const customStyles = {
        ...
        'input-container':(provided, state)=>({
            ...provided,
            borderRadius:'50px',
            boxShadow:'none'
        }),
                    ...
                    <div className="col-12">
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <SELECT className="col-12 m-0 festival shadow-none" classNamePrefix="festival"  options={Festivals} styles={customStyles}  value={festival} onClick={(e)=> {setFestival(e.target.value) }}/>
