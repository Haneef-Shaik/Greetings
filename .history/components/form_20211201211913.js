                    ...
                    <div className="col-12">
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <div className="footerBanner p-2 m-0" style={{backgroundColor: '#FFFFFF',width: '100%'}}>
                                    <button className="bg-danger btn p-0 "  >Preview</button>
                                    <button className="bg-danger btn p-0 "  > Create Link </button>
                                </div>
                            </form>
                        </div>
                    </div>
