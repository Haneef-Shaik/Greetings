                        ...
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <button onClick={()=>setImg('christmas.png')} className="btn p-1" checked>
                                    <IMAGE src='/images/christmas/christmas.png' width="120" height="150" loading='eager' priority/>                       
                                </button> 
                                
                                <button onClick={()=>setImg('christmas1.png')} className="btn p-1">
                                    <IMAGE src='/images/christmas/christmas1.png' width="120" height="150" loading='eager' priority/>                       
                                </button> 
                                
                                <button onClick={()=>setImg('christmas2.png')} className="btn p-1">
                                    <IMAGE src='/images/christmas/christmas2.png' width="120" height="150" loading='eager' priority/>                       
                                </button> 
