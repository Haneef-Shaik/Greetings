                    ...
                    <div className="col-12">
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <button   checked className="btnhighlight">
                                    <IMAGE className={styles.btnhighlight} onClick={(e)=>{setImg('1' )}} src={`/images/${festivalName}/1.webp`} width="120" height="150" loading='eager' priority/>
                                </button> 
                                
                                <button  className="btnhighlight">
                                    <IMAGE className={styles.btnhighlight} onClick={(e)=>{setImg('2' )}} src={`/images/${festivalName}/1.webp`} width="120" height="150" loading='eager' priority/>

                                </button> 
                                
                                <button  className="btnhighlight">
                                <IMAGE className={styles.btnhighlight} onClick={(e)=>{setImg('3' )}} src={`/images/${festivalName}/1.webp`} width="120" height="150" loading='eager' priority/>

                                </button> 
                                
                                <button  className="btnhighlight">
                                <IMAGE className={styles.btnhighlight} onClick={(e)=>{setImg('4' )}} src={`/images/${festivalName}/1.webp`} width="120" height="150" loading='eager' priority/>
