    ...
    <div className={styles.socialShare}>
      <div className={styles.container}>
        ...
        <div className={styles.socialShareIcons}>
          <div style={{backgroundColor:'#aaaf',borderRadius: '50%',display: 'inline-block',margin:'0',padding: '0'}}>
          <IMAGE src="/images/copy-64.png" width="40" height="40" style={{padding:'0',margin:'0'}}  />
          </div>
