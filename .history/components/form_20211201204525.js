                        ...
                        <div className={styles.formContainer} >
                            <form className="formStyle">
                                ...
                                <div>
                                    ...
                                    <input type="radio" name="BgImage" id="img1" hidden="true" />
                                    <input type="radio" name="BgImage" id="img2" hidden="true" />
                                    <input type="radio" name="BgImage" id="img3" hidden="true" />
                                    <input type="radio" name="BgImage" id="img4" hidden="true" />
                                </div>
                            </form>
                        </div>
                    </div>
