                    ...
                    <div className="col-12">
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <SELECT className="col-12" classNamePrefix="festival" styles={customStyles}  options={Festivals} defaultValue={Festivals[0]} onClick={(e)=> {setFestival(e.target.value);console.log(festival) }}/>
                                ...
                                <button onClick={()=>{setImg('christmas.png');console.log(IMG1)}} className="btn p-1 " checked>
                                ...
                                <button onClick={()=>setImg('christmas1.png')} className="btn p-1">
                                    ...
                                    <IMAGE src='/images//christmas1.webp' width="120" height="150" loading='eager' priority/>                       
                                    </div>
                                </button> 
                                
                                <button onClick={()=>setImg('christmas2.png')} className="btn p-1">
                                    <IMAGE src={`/images/${festival}/christmas2.webp`} width="120" height="150" loading='eager' priority/>                       
                                </button> 
