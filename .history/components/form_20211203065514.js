...
function Edit() {
    ...
    const customStyles = {
        ...
        '.css-wmw4vi-ReactDropdownSelect':(provided, state) => ({
            width:'300px',
        })
                    ...
                    <div className="col-12">
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <SELECT className="col-12 m-0 festival"  options={Festivals} styles={customStyles} value={festival} onClick={(e)=> {setFestival(e.target.value) }}/>
