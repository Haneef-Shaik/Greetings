                    ...
                    <div className="col-12">
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <SELECT className="col-12" classNamePrefix="festival" styles={customStyles}  options={Festivals}  onClick={(e)=> {e.preventDefault(); setFestival(e.target.value);console.log(festival) }}/>
