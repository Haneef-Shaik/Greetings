                        ...
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                <input type="text" placeholder="Enter Your Name" className={styles.myInp} required />
			                        <Select defaultValue="Happy Birthday" style={{ width: 220 }} onChange={handleChange}>
                                        <Option value="Happy Birthday">Happy Birthday</Option>
                                        <Option value="Happy christmas">Happy christmas</Option>
                                ...
                                <button onClick={()=>setImg('christmas.png')} className="btn p-1 " checked class="btnhighlight">
                                ...
                                <button onClick={()=>setImg('christmas2.png')} className="btn p-1" class="btnhighlight">>
