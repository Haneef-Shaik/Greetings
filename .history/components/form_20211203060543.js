...
function Edit() {
    ...
    const customStyles = {
        ...
        'react-select-23-input':(provided,state)=>({
            ...provided,
            boxShadow:'none'
        })
    }
                    ...
                    <div className="col-12">
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <SELECT className="col-12" classNamePrefix='festival' options={Festivals} styles={customStyles} value={festival} onClick={(e)=> {setFestival(e.target.value) }}/>
