                        ...
                        <div className={styles.formContainer} >
                            <form className="formStyle">
                                ...
                                <div className="footerBanner">
                                    <div className="row ">
                                        <div className="col p-0 m-0 d-flex justify-content-around align-items-center "  > <button className="btn btn-primary"  >Preview</button></div>
                                        <div className="col p-0 m-0 d-flex justify-content-around align-items-center "  > <button className="btn btn-primary"  > Create Link </button></div>
                                    </div>
                                </div>
                            </form>
                        </div>
