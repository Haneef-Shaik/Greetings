    ...
    <div className={styles.socialShare}>
      <div className={styles.container}>
        ...
        <div className={styles.url}>
            <CopyToClipboard text={newURL} style={{display:'block',overflow:'hidden',position:'relative',wordWrap:'no-wrap'}}>
              <h5 style={{display:'inline',wordWrap:'break-word'}}>{newURL}</h5>
            </CopyToClipboard>
        </div>
