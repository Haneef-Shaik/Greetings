                    ...
                    <div className="col-12">
                        <div className={styles.formContainer} >
                            <form className="formStyle">
                                ...
                                <div className="d-flex justify-content-around align-items-center flex-wrap mt-1">
                                    {/* <label htmlFor="img1">
                                ...
                                <button onClick={()=>setImg('christmas1.png')}>
                                    <IMAGE src='/images/christmas/christmas1.png' width="100" height="150" />                       
                                </button> 
                                
                                <button onClick={()=>setImg('christmas2.png')}>
                                    <IMAGE src='/images/christmas/christmas2.png' width="100" height="150" />                       
                                </button> 
