                        ...
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <div className="footerBanner p-2 m-0 d-flex justify-content-around" style={{width: '100%'}}>
                                        <Link href={`/preview?event=${festivalName  }&name=${ UserName==null?"name":UserName }&bgImg=${IMG1} `} >
                                    <button type="submit" className="p-0" style={{backgroundColor:'#EABC32',boxShadow:'inset 4px -4px 8px #f0f0f0',width:'100%',borderRadius:'5px',color:'#000',position:'relative' }} > 
                                            <a style={{textDecoration: 'none',color:'#000',fontFamily:'Times New Roman',fontWeight:'bold',fontSize:'1.5rem',backgroundColor:'red'}}> Preview </a>
