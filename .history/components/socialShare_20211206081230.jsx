    ...
    <div className={styles.socialShare}>
      <div className={styles.container}>
        ...
        <div className={styles.socialShareIcons}>
          <span >
              <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-clipboard" viewBox="0 0 16 16" style={{backgroundColor:'blue',borderRadius:'50%'}}>
