                        ...
                        <div className={styles.formContainer} >
                            <form className="formStyle">
                                ...
                                <div className="footerBanner">
                                    <div className="row">
                                        <div className="col p-0"><button className="btn btn-primary" style={{width:100}} >Preview</button></div>
                                        <div className="col p-0"><button className="btn btn-primary" style={{width:100}} > Create Link </button></div>
                                    </div>
                                </div>
                            </form>
                        </div>
