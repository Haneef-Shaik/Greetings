...
import imgs2 from '../pubiic/images/christmas/christmas1.png'
                    ...
                    <div classNameName="col-md-6">
                        <form>
                          <div className="form-group row">
                            <label for="inputPassword" className="col col-form-label">Name: </label>
                          ...
                          <div className="form-group row">
                            <label for="inputPassword" className="col-4 col-form-label">Heading Color: </label>
...
className InvitationCard extends React.Component{
    render(){
        return (
            
                <div classNameName="body p-2" style={{backgroundColor: this.props.c,backgroundImage:`url(${this.props.im})`,backgroundSize:350,backgroundRepeat:'no-repeat'}} >
