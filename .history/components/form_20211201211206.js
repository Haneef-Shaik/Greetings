                        ...
                        <div className={styles.formContainer} >
                            <form className="formStyle">
                                ...
                                <div className="footerBanner">
                                    <div className="row ">
                                        <div className="col p-0 m-0 d-flex justify-content-around "  > <button className="bg-danger btn p-0 m-0"  >Preview</button></div>
                                        <div className="col p-0 m-0 d-flex justify-content-around "  > <button className="bg-danger btn p-0 m-0"  > Create Link </button></div>
                                    </div>
                                </div>
                            </form>
                        </div>
