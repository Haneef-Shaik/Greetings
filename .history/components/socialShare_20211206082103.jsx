    ...
    <div className={styles.socialShare}>
      <div className={styles.container}>
        ...
        <div className={styles.socialShareIcons}>
          <div style={{border: '1px solid red',borderRadius: '50%',display:'inline-block',height: '45px',width: '45px'}} >
          <img src="https://img.icons8.com/pastel-glyph/40/000000/copy--v2.png"/>
          </div>
