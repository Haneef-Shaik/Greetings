                    ...
                    <div className="col-12">
                        <div className={styles.formContainer} >
                            <form className="formStyle">
                                ...
                                <button onClick={()=>setImg('/images/christmas/christmas.png')}>
                                    <IMAGE src='/images/christmas/christmas.png' width="200" height="200" />                       
                                </button> 
                                <button onClick={()=>setImg('/images/christmas/christmas1.png')}>
                                    <IMAGE src='/images/christmas/christmas1.png' width="200" height="200" />                       
                                </button> 
                                <button onClick={()=>setImg('/images/christmas/christmas2.png')}>
