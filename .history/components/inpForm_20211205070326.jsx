                        ...
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <div className="d-flex justify-content-around align-items-center flex-wrap mt-4" style={{backgroundColor:'darkgrey',borderRadius:'15px',padding:'10px'}}>
                                    ...
                                    <IMAGE onClick={(e)=>{setImg('1' );e.target.style={}}} src={`/images/${festivalName}/1.webp`} width="120" height="150" loading='eager' priority/>                       
                                    <IMAGE onClick={(e)=>{setImg('2' );e.target.style={}}} src={`/images/${festivalName}/2.webp`} width="120" height="150" loading='eager' priority/>                       
                                    <IMAGE onClick={(e)=>{setImg('3' );e.target.style={}}} src={`/images/${festivalName}/3.webp`} width="120" height="150" loading='eager' priority/>                       
                                    <IMAGE onClick={(e)=>{setImg('4' );e.target.style={}}} src={`/images/${festivalName}/4.webp`} width="120" height="150" loading='eager' priority/>                       
