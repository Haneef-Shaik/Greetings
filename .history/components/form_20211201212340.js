                        ...
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <div className="footerBanner p-2 m-0 d-flex justify-content-around" style={{width: '100%'}}>
                                    <button className="btn px-4 " style={{backgroundColor:'#EABC32',boxShadow:'inset 4px -4px 0px #EABC32' }} > Preview</button>
                                    <button className="btn px-4 " style={{backgroundColor:'#EABC32',boxShadow:'inset 4px -4px 0px #EABC32' }} > Create Link </button>
                                </div>
                            </form>
                        </div>
                    </div>
