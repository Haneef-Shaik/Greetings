      ...
      <div className={styles.container}>
        ...
        <div className={styles.socialShareIcons}>
          <span style={{borderRadius:'50%',backgroundColor:'red',}}>
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-clipboard" viewBox="0 0 16 16" style={{backgroundColor:'blue',padding:'10px'}}>
