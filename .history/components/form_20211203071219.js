                    ...
                    <div className="col-12">
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <SELECT className="col-12 m-0 festival " classNamePrefix="festival" styles={customStyles}  options={Festivals}  value={festival} onClick={(e)=> {setFestival(e.target.value) }}/>
