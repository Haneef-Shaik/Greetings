                        ...
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <button onClick={()=>setImg('christmas.png')} className="btn p-1 " checked>
                                    <div onFocus={(event)=>event.target.style.border = '5px solid blue'} className="MyImgCon">
                                ...
                                <button onClick={()=>setImg('christmas1.png')} className="btn p-1">
                                    <div onFocus={(event)=>{event.target.style.border = '5px solid blue';'.MyImgCon'.target.style.border = none }}>
