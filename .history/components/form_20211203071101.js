                    ...
                    <div className="col-12">
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                <input type="text" placeholder="Enter Your Name" className="col-12 myInp" required />

                                <SELECT className="col-12 m-0 festival " classNamePrefix="festival"  options={Festivals}  value={festival} onClick={(e)=> {setFestival(e.target.value) }}/>

                                <input type="text" placeholder="Description" className="col-12 myInp" optional />
