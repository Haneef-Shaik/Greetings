  ...
  const handleClose = () => {
    ...
    return (
                        ...
                        <div className={styles.formContainer} >
                            <form className="formStyle p-0">
                                ...
                                <div className="footerBanner p-2 m-0 d-flex justify-content-around" style={{width: '100%'}}>
                                    ...
                                    <Button variant="outlined" onClick={handleClickOpen} style={{backgroundColor:'#EABC32',boxShadow:'inset 4px -4px 8px #f0f0f0',width:'100%',borderRadius:'5px',color:'#000' }} >
        Share
      </Button>
      <Dialog
        open={open}
      ...
      >
        ...
        <DialogContent>
                                    <DialogContentText>Shre Link</DialogContentText>
        </DialogContent>
        <DialogActions>
