    ...
    <div className={styles.socialShare}>
      <div className={styles.container}>
        ...
        <div className={styles.socialShareIcons}>
          <span style={{borderRadius:'50%',backgroundColor:'gery'}}>
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="18" fill="currentColor" className="bi bi-clipboard" viewBox="0 0 16 16">
